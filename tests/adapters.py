...
from cs336_basics.transfomer import *
from cs336_basics.lmtrain import *
...
def run_transformer_block(
    ...
    """
    transfomer = TransformerBlock(d_model, num_heads, d_ff, max_seq_len, theta)
    transfomer.load_weights(weights)
    return transfomer(in_features)
